...
import { Question15Page } from '../question15/question15.page';
...
this.route.queryParams
     .subscribe(params =>
  {
      console.log(params);
       ...
       console.log(this.answer1, this.answer2,this.answer3,this.answer4,this.answer5,this.answer6,this.answer7,this.answer8,this.answer9,this.answer10,this.answer11,this.answer12,this.answer13,this.answer14,
        this.CA1,this.CA2,this.CA3,this.CA4,this.CA5,this.CA6,this.CA7,this.CA8,this.CA9,this.CA10,this.CA11,this.CA12,this.CA13,this.CA14);
  });
  }
 select(option, answer){

 this.storage.set('answer14',answer);
 this.answer14 = answer;
  this.storage.get('CA14').then((value) => {
  this.CA14 = value ;
      });
 }
 goNext(){
 if(this.answer14==this.CA14){
   this.storage.get('correctAns').then((value) =>{
     var CA = value ;
     this.tempCA =(CA+1);
     this.storage.set('correctAns', this.tempCA);
     this.storage.set('remark14', 'correct');
   })

 }else{
   this.storage.set('remark14', 'incorrect');
 }
 ...
 console.log(this.answer1,this.answer2,this.answer2,this.answer3,this.answer4,this.answer5,this.answer6,this.answer7,this.answer8,
  this.answer9,this.answer10,this.answer11,this.answer12,this.answer13,this.answer14,
  this.CA1,this.CA2,this.CA3,this.CA4,this.CA5,this.CA6,this.CA7,this.CA8,this.CA9,this.CA10,this.CA11,this.CA12,this.CA13,this.CA14);
 this.router.navigate(['/question15'], { queryParams:{ answer1:this.answer1,answer2:this.answer2,answer3:this.answer3, answer4:this.answer4,
  ...
  answer12:this.answer12,answer13:this.answer13,answer:this.answer14,
   CA1:this.CA1,CA2:this.CA2,CA3:this.CA3,CA4:this.CA4,CA5:this.CA5,CA6:this.CA6,CA7:this.CA7,CA8:this.CA8,CA9:this.CA9,CA10:this.CA10,CA11:this.CA11,CA12:this.CA12,CA13:this.CA13,CA14:this.CA14} });
}
